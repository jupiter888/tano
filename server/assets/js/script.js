...
(function($) {
  $.extend($.fn, {
    ...
    themePlugins: function(refresh) {
      ...
      return {
        themePluginFakeLoader: function() {
          ...
          if ($fakeLoaders.length > 0) {
            ...
            $document.themeLoadPlugin(
              ["fakeLoader/fakeLoader.min.js"],
              ["fakeLoader/fakeLoader.css"],
              themePluginFakeLoaderInit
            );
          }
        },
          ...
          if ($countTos.length > 0) {
            var themePluginCountToInit = function() {
              $countTos.each(function() {
                var $this = $(this), delay = $this.data("delay") || 0;
                $this.waypoint(
                  function() {
                    setTimeout(function() {
                      $this.countTo({
          ...
          if ($vides.length > 0) {
            var themePluginVideInit = function() {
              $vides.each(function() {
                ...
                videoBgOptions = jQuery.extend(
                  videoBgDefaultOptions,
                  videoBgOptions
                );
                ...
                if (videoBgVideos !== null) {
                  videoBg
                    .addClass("bg-video")
                    .vide(videoBgVideos, videoBgOptions);
                }
              });
            };
            $document.themeLoadPlugin(
        ...
        themePluginBootstrapSwitch: function() {
          ...
          if ($bootstrapSwitches.length > 0) {
            ...
            $document.themeLoadPlugin(
              ...
              [
                "_overrides/plugin-bootstrap-switch.min.css",
          ...
          if ($jpanelMenus.length > 0) {
            ...
            $document.themeLoadPlugin(
              [
                ...
                "https://cdn.jsdelivr.net/jquery.smartresize/0.1/jquery.debouncedresize.js"
              ],
              [],
        ...
        themePluginFixTo: function() {
          ...
          // ----------------------------------------------------------------
          var $fixTos = context.find(
            "[data-toggle=clingify], [data-toggle=sticky]"
          );
          if ($fixTos.length > 0) {
                    ...
                    if (stickyBreakpoint) {
                      if ($(window).width() <= stickyBreakpoint) {
                        ...
                        if (sticky.data("fixto-instance") === "") {
                          sticky
                            .addClass("sticky")
                            .fixTo(stickyParent, sticky.data("stickSettings"));
                        }
                      }
                    }
        ...
        themePluginFlexslider: function() {
          ...
          if ($flexsliders.length > 0) {
                ...
                var sliderSettings = {
                  ...
                  start: function(slider) {
                    ...
                    slider.find(".slide-bg").each(function() {
                      jQuery(this).css({
                        "background-image": "url(" +
                          jQuery(this).data("bg-img") +
                          ")"
                      });
                      jQuery(this)
                        .css("visibility", "visible")
                        .addClass("animated")
                        .addClass(jQuery(this).data("animate-in"));
                    });
                    ...
                    slider
                      .find(".slide")
                      .eq(1)
                      .find("[data-animate-in]")
                      .each(function() {
                        jQuery(this).css("visibility", "hidden");
                        if (jQuery(this).data("animate-delay")) {
                          jQuery(this).addClass(
                            jQuery(this).data("animate-delay")
                          );
                        }
                        if (jQuery(this).data("animate-duration")) {
                          jQuery(this).addClass(
                            jQuery(this).data("animate-duration")
                          );
                        }
                        jQuery(this)
                          .css("visibility", "visible")
                  ...
                  before: function(slider) {
                    slider.find(".slide-bg").each(function() {
                      jQuery(this)
                        .removeClass(jQuery(this).data("animate-in"))
            ...
            $document.themeLoadPlugin(
              ...
              [
                "_overrides/plugin-flexslider.min.css",
                "flexslider/flexslider.css"
              ],
              themePluginFlexsliderInit
            );
          }
        },
        ...
        themePluginSliderRevolution: function() {
          ...
          if ($sliderRevolutions.length > 0) {
            var themePluginSliderRevolutionInit = function() {
              ...
              $sliderRevolutions.each(function() {
                ...
                var sliderRevSettingsDefaults = {
                  extensions: pluginsLocation +
                    "slider-revolution/revolution/js/extensions/",
                ...
                sliderRevEl.hide();
                sliderRevSettings = $.extend(
                  sliderRevSettingsDefaults,
                  sliderRevEl.data()
                );
            ...
            $document.themeLoadPlugin(
              [
                "slider-revolution/revolution/js/jquery.themepunch.tools.min.js?v=" +
                  SLIDER_REV_VERSION,
                "slider-revolution/revolution/js/source/jquery.themepunch.revolution.js?v=" +
                  SLIDER_REV_VERSION
              ],
              [
                "_overrides/plugin-slider-revolution.min.css",
                "slider-revolution/revolution/css/settings.css?v=" +
                  SLIDER_REV_VERSION
              ],
              function() {
          ...
          if ($backstretches.length > 0) {
            var themePluginBackstretchInit = function() {
              $backstretches.each(function() {
                ...
                jQuery.each(
                  backstretchEl.data("backstretch-imgs").split(","),
                  function(k, img) {
                ...
                if (backstretchImgs) {
                  ...
                  backstretchSettings = $.extend(
                    {},
                    backstretchSettings,
                    backstretchEl.data()
                  );
                  backstretchTarget.backstretch(
                    backstretchImgs,
                    backstretchSettings
                  );
                  ...
                  if (backstretchEl.data("backstretch-overlay") !== false) {
                    ...
                    if (backstretchEl.data("backstretch-overlay-opacity")) {
                      $(".backstretch")
                        .find(".backstretch-overlay")
                        .css("background", "white")
                        .fadeTo(
                          0,
                          backstretchEl.data("backstretch-overlay-opacity")
                        );
                    }
                  }
                }
        ...
        themePluginFitVids: function() {
          ...
          if ($fitVids.length > 0) {
            ...
            $document.themeLoadPlugin(
              ["fitvidsjs/jquery.fitvids.js"],
              [],
              themePluginFitVidsInit
            );
          }
        },
        ...
        themePluginOwlCarousel: function() {
          ...
          if ($owlCarousels.length > 0) {
            var themePluginOwlCarouselInit = function(context) {
              $owlCarousels.each(function() {
                var $owlCarousel = $(this),
                  owlCarouselSettings =
                    $owlCarousel.data("owl-carousel-settings") || null;
              ...
              $owlCarouselThumbs.each(function() {
                var $owlThumbsWrap = $(this),
                  ...
                  $owlTarget =
                    $($owlThumbsWrap.data("owl-carousel-thumbs")) || null,
                  owlThumbsCarousel =
                    ($owlThumbsWrap.data("toggle") !== "" &&
                      $owlThumbsWrap.data("toggle") == "owl-carousel") ||
                    false;

                if ($owlTarget) {
                  $owlThumbs.eq(0).addClass("active");
                  $owlThumbs.on("click", function(event) {
                    $owlTarget.trigger("to.owl.carousel", [
                      $(this).parent().index(),
                      300,
                      true
                    ]);
                  ...
                  $owlTarget.on("changed.owl.carousel", function(event) {
                    ...
                    if (owlThumbsCarousel) {
                      if (
                        ...
                        $owlThumbsWrap.trigger("to.owl.carousel", [
                          item,
                          300,
                          true
                        ]);
            ...
            $document.themeLoadPlugin(
              ...
              [
                "_overrides/plugin-owl-carousel.min.css",
        ...
        themePluginMagnificPopup: function() {
          ...
          if ($magnificPopups.length > 0) {
            var themePluginMagnificPopupInit = function() {
              ...
              $magnificPopups.each(function() {
                ...
                if ($(this).data("magnific-popup-settings") !== "") {
                  magnificPopupSettingsExtras = $(this).data(
                    "magnific-popup-settings"
                  );
                }
                magnificPopupSettings = jQuery.extend(
            ...
            $document.themeLoadPlugin(
              ...
              [
                "_overrides/plugin-magnific-popup.min.css",
        ...
        themePluginZoom: function() {
          ...
          if ($zooms.length > 0) {
            ...
            $document.themeLoadPlugin(
              [
                "https://cdnjs.cloudflare.com/ajax/libs/jquery-zoom/1.7.18/jquery.zoom.min.js"
              ],
              [],
              themePluginZoomInit
            );
            ...
            var themePluginCountdownInit = function() {
              $countdowns.each(function() {
                var $this = $(this),
                  ...
                  coundownExpireText =
                    $this.data("countdown-expire-text") || null;
        ...
        themePluginCubePortfolio: function() {
          ...
          if ($cubePortfolios.length > 0) {
              ...
              $cubePortfolios.each(function() {
                ...
                settings.singlePageInlineCallback = function(url, element) {
                  ...
                  if (content !== "ajax" && $(content).size() > 0) {
                    ...
                    t.updateSinglePageInline(
                      "Content Error! Please refresh the page!"
                    );
                  }
                };
                settings.singlePageCallback = function(url, element) {
                  ...
                  $.ajax({
                    ...
                    .done(function(result) {
                      ...
                      var html = $(result);
                      html.themeRefresh();
                      var counterMarkup, animationFinish, scripts, isWrap;
            ...
            $document.themeLoadPlugin(
              [
                "https://cdnjs.cloudflare.com/ajax/libs/jquery.imagesloaded/4.1.1/imagesloaded.pkgd.min.js",
                "cubeportfolio-jquery-plugin/cubeportfolio/js/jquery.cubeportfolio.js"
              ],
              [
                "_overrides/plugin-magnific-popup.min.css",
                "_overrides/plugin-cube-portfolio.min.css",
                "cubeportfolio-jquery-plugin/cubeportfolio/css/cubeportfolio.css"
              ],
    ...
    themeCustom: function(refresh) {
      ...
      context.find('[data-scroll="scroll-state"]').each(function() {
        var $scroll = $(this),
          $doc = $(document),
          scrollAmount =
            $scroll.data("scroll-amount") || $(window).outerHeight();
      ...
      if (overlayMenus.length > 0) {
        overlayMenus.each(function() {
          var $this = jQuery(this), target = $this.data("target") || null;
        ...
        context.find('[data-dismiss="overlay"]').each(function() {
          var $this = jQuery(this),
            ...
            $trigger =
              jQuery(
                '[data-toggle="overlay"][data-target="' + $target + '"]'
              ) || null;
      ...
      context.find(".theme-colours a").click(function() {
        ...
        if (c !== defaultColour) {
          context
            .find("#colour-scheme")
            .attr("href", "assets/css/colour-" + c + ".css?x=" + cacheBuster);
        } else {
      ...
      // ----------------------------------------------------------------
      var progressBarsAnimated = context.find(
        ...
        var initProgressBarsAnimated = function() {
          progressBarsAnimated.each(function() {
            ...
            $progress.waypoint(
              function() {
                currentStyles +=
                  "width: " + $progress.attr("aria-valuenow") + "% !important;";
                $progress
                  .attr("style", currentStyles)
      ...
      if (modalsOnload.length > 0) {
        modalsOnload.each(function() {
          var $modal = $(this), delay = $modal.data("modal-delay") || null;
      ...
      if (scrollLinks.length > 0) {
        ...
        scrollLinks.click(function() {
          if (
            ...
            var $this = $(this), target = $(this.hash), offset = 2;
    ...
    themeSubMenus: function() {
      var context = $(this);
      var $tabsPills = $(
        '.dropdown-menu [data-toggle="tab"], .dropdown-menu [data-toggle="pill"]'
      );
      ...
      $tabsPills.on("shown.bs.tab", function(e) {
        ...
        $(document)
          .find('[data-target="' + toSelectors + '"]')
          .addClass("active");
        $(document)
          .find('[data-target="' + fromSelectors + '"]')
          .removeClass("active");
      });

      context
        .find(".dropdown-menu [data-toggle=dropdown]")
      ...
      if (js.length > 0) {
        ...
        $.each(js, function(index, value) {
          ...
          if (placement === undefined) {
            ...
            $('script[src*="bootstrap.min.js"]').after(
              '<script src="' + themeLoadPluginPath(value) + '"></script>'
            );
            internalCallback();
          } else if (placement === "prepend") {
            $('script[src*="bootstrap.min.js"]').before(
              '<script src="' + themeLoadPluginPath(value) + '"></script>'
            );
            internalCallback();
